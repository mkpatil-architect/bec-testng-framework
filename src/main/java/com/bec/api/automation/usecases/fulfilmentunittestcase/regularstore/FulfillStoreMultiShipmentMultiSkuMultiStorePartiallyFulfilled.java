...
public class FulfillStoreMultiShipmentMultiSkuMultiStorePartiallyFulfilled extends GenericTestClass {
    private static String name = client2+"FulfillStoreMultiShipmentMultiSkuMultiStorePartiallyFulfilled";
    ...
    private void storeSetUp() throws Throwable {
        ...
        storePathList.add("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/storepayload/store_2019.json");
        storePathList.add("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/storepayload/store_2020.json");
    ...
    private void inventoryUpdateSetUp() throws Throwable {
        GenericTestClass.inventorySetup("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/inventoryupdatepayload/2_fulfill_store_multi_shipment_multi_sku_multi_store_partially_fulfilled_inventory_update.json");
    }

    //orderSetUp
    @Test(priority = 4)
    private void orderSetUp() throws Throwable {
        String orderSetUpObject = GenericTestClass.runOrderSetUp("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/orderpayload/2_fulfill_store_multi_shipment_multi_sku_multi_store_partially_fulfilled_order.json", name);
    ...
    private void orderVerification() throws Throwable {
        String path = "src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/orderresponsepayload/2_fulfill_store_multi_shipment_multi_sku_multi_store_partially_fulfilled.json";
