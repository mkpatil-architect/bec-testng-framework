...
public class FulfillStoreSingleShipmentSingleSkuSingleStorePartiallyFulfilled extends GenericTestClass {
    ...
    private static String name = client1+"FulfillStoreSingleShipmentSingleSkuSingleStorePartiallyFulfilled";
    ...
    private void inventoryUpdateSetUp() throws Throwable {
        GenericTestClass.inventorySetup("src/main/resources/payloads/fulfilment_unit_test_payload/dcmh/inventoryupdatepayload/fulfill_store_single_shipment_single_sku_single_store_partially_fulfilled_inventory_update.json");
    }

    //orderSetUp
    @Test(priority = 4)
    private void orderSetUp() throws Throwable {
        String orderSetUpObject = GenericTestClass.runOrderSetUp("src/main/resources/payloads/fulfilment_unit_test_payload/dcmh/orderpayload/fulfill_store_single_shipment_single_sku_single_store_partially_fulfilled_order.json", name);
    ...
    public void orderVerification() throws Throwable {
        String path = "src/main/resources/payloads/fulfilment_unit_test_payload/dcmh/orderresponsepayload/18_fulfill_store_single_shipment_single_sku_single_store_partially_fulfilled.json";
