...
public class FulfillStoreMultiShipmentMultiSkuMultiStoreFulfilled extends GenericTestClass {
    ...
    private static String name = client2+"FulfillStoreMultiShipmentMultiSkuMultiStoreFulfilled";
    ...
    private void storeSetUp() throws Throwable {
        ...
        storePathList.add("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/storepayload/store_2012.json");
        storePathList.add("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/storepayload/store_2013.json");
    ...
    private void inventoryUpdateSetUp() throws Throwable {
        GenericTestClass.inventorySetup("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/inventoryupdatepayload/1_fulfill_store_multi_shipment_multi_sku_multi_store_fulfilled_inventory_update.json");
    }

    //orderSetUp
    @Test(priority = 4)
    private void orderSetUp() throws Throwable {
        String orderSetUpObject = GenericTestClass.runOrderSetUp("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/orderpayload/1_fulfill_store_multi_shipment_multi_sku_multi_store_fulfilled_order.json", name);
    ...
    private void orderVerification() throws Throwable {
        String path = "src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/orderresponsepayload/1_fulfill_store_multi_shipment_multi_sku_multi_store_fulfilled.json";
