...
public class FulfillDcSingleShipmentMultiSkuBothFulfilled extends GenericTestClass {

    private static String name = client1+"FulfillDcSingleShipmentMultiSkuBothFulfilled";
    ...
    private void storeSetUp() throws Throwable {
        ...
        pathList.add("src/main/resources/payloads/fulfilment_unit_test_payload/dcmh/storepayloads/store_2004.json");
    ...
    private void inventoryUpdate() throws Throwable {
        GenericTestClass.inventorySetup("src/main/resources/payloads/fulfilment_unit_test_payload/dcmh/inventoryupdatepayload/fulfill_dc_single_shipment_multi_sku_both_fulfilled_inventory_update.json");
    }

    //orderSetUp
    @Test(priority = 4)
    private void orderSetUp() throws Throwable {
        String orderSetUpObject = GenericTestClass.runOrderSetUp("src/main/resources/payloads/fulfilment_unit_test_payload/dcmh/orderpayload/fulfill_dc_single_shipment_multi_sku_both_fulfilled_order.json", name);
    ...
    public void orderVerification() throws Throwable {
        String path = "src/main/resources/payloads/fulfilment_unit_test_payload/dcmh/orderresponsepayload/21_fulfill_dc_single_shipment_multi_sku_both_fulfilled.json";
