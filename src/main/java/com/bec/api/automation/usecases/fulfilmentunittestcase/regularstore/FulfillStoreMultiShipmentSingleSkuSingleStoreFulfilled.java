...
public class FulfillStoreMultiShipmentSingleSkuSingleStoreFulfilled extends GenericTestClass {
    private static String name = client2+"FulfillStoreMultiShipmentSingleSkuSingleStoreFulfilled";
    ...
    private void storeSetUp() throws Throwable {
        GenericTestClass.runStoreSetup("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/storepayload/store_2008.json");
    }

    //inventoryUpdate setUp
    @Test(priority = 3)
    private void inventoryUpdateSetUp() throws Throwable {
        GenericTestClass.inventorySetup("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/inventoryupdatepayload/6_fulfill_store_multi_shipment_single_sku_single_store_fulfilled_inventory_update.json");
    }

    //orderSetUp
    @Test(priority = 4)
    private void orderSetUp() throws Throwable {
        String orderSetUpObject = GenericTestClass.runOrderSetUp("src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/orderpayload/6_fulfill_store_multi_shipment_single_sku_single_store_fulfilled_order.json", name);
    ...
    private void orderVerification() throws Throwable {
        String path = "src/main/resources/payloads/fulfilment_unit_test_payload/regularstore/orderresponsepayload/6_fulfill_store_multi_shipment_single_sku_single_store_fulfilled.json";
